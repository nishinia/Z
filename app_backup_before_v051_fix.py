...
if parse_btn_v051:
    try:
        ...
        st.session_state["v051_project_info_text"] = json.dumps(
            project_info_v051,
            ensure_ascii=False,
            indent=4
        )

        st.session_state["v051_cylinder_config_text"] = json.dumps(
            cylinder_config_v051,
            ensure_ascii=False,
            indent=4
        )

        st.session_state["v051_station_config_text"] = json.dumps(
            station_config_v051,
            ensure_ascii=False,
            indent=4
        )

        st.session_state["v051_device_config_full_text"] = json.dumps(
            device_config_v051,
            ensure_ascii=False,
            indent=4
        )

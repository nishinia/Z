...
FINAL_ZIP = OUTPUT_DIR / "AI_Device_Project_Package_V070_Final.zip"
...
st.set_page_config(
    page_title="PLC数字工程师 V0.7.0",
    page_icon="🏭",
    layout="wide",
)

st.title("🏭 PLC数字工程师 V0.7.0 最终成品版")
...
if config:
    ...
    tab_project, tab_cylinder, tab_station, tab_axis, tab_json = st.tabs([
        "Project Info",
        "Cylinder Config",
        "Station Configs",
        "Axis Config",
...
if result and result.get("ok"):
    ...
    if zip_path.exists():
        st.download_button(
            label="⬇️ 下载 V0.7.0 最终工程包 ZIP",
            data=zip_path.read_bytes(),
            file_name="AI_Device_Project_Package_V070_Final.zip",
